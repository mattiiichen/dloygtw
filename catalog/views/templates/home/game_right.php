...
<link href='https://fonts.googleapis.com/css?family=Architects+Daughter' rel='stylesheet' type='text/css'>
 <?php echo link_tag('stylesheet/right_game.css'); ?>
...
<div class="right_info">
	...
	<?php echo form_open('game/search') ?>
	
	<div class="searchBOX">
	<p><?php echo $this->lang->line('game_right_search'); ?></p>
	
		<input type="text" class="searchMF" name="searchMF" id="search" placeholder="<?php echo $this->lang->line('game_right_search_text'); ?>"/><input type="submit" class="searchMFBT" name="searchMFBT" value="">
	</div>
	</form>
	<div class="blogarchive">
	<p><?php echo $this->lang->line('game_right_archive'); ?></p>
	</div>
