...
<link href='https://fonts.googleapis.com/css?family=Architects+Daughter' rel='stylesheet' type='text/css'>
 <?php echo link_tag('stylesheet/right_think.css'); ?>
 
 
<div class="right_info">
	
	
	<div class="thinking"><p><?php echo $this->lang->line('think_right_think'); ?></p>
	...
	<br/><br/><br/>
<!--	<iframe width="300" height="169" src="<?php echo $recently_think[0]['youtubeurl']; ?>" frameborder="0" allowfullscreen></iframe>-->
	</div>
	...
	<?php echo form_open('think/search') ?>
	
	<div class="searchBOX">
	<p><?php echo $this->lang->line('think_right_search'); ?></p>
	
		<input type="text" class="searchMF" name="searchMF" id="search" placeholder="<?php echo $this->lang->line('think_right_search_text'); ?>"/><input type="submit" class="searchMFBT" name="searchMFBT" value="">
	</div>
	</form>
	<div class="blogarchive">
	<p><?php echo $this->lang->line('think_right_archive'); ?></p>
	</div>
