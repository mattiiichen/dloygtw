...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2015 at 10:26 AM
...
--
-- Truncate table before insert `imagecategory`
--
...
--
-- Truncate table before insert `recently`
--
...
--
-- Table structure for table `recently_category`
--
...
--
-- Truncate table before insert `recently_category`
--

TRUNCATE TABLE `recently_category`;
--
-- Dumping data for table `recently_category`
--
...
--
-- Table structure for table `something_new`
--
...
--
-- Truncate table before insert `something_new`
--
...
--
-- Table structure for table `something_new_category`
--
...
--
-- Truncate table before insert `something_new_category`
--

TRUNCATE TABLE `something_new_category`;
--
-- Dumping data for table `something_new_category`
--
...
--
-- Indexes for table `recently_category`
--
ALTER TABLE `recently_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `something_new`
--
ALTER TABLE `something_new`
  ADD PRIMARY KEY (`new_id`);

--
-- Indexes for table `something_new_category`
--
...
--
-- AUTO_INCREMENT for table `recently`
--
ALTER TABLE `recently`
